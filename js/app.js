...
form.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    void requestPostNotification(currentUser, { type: "thread", threadId: doc.id }).catch(console.warn);
...
loadThreads();
if ("serviceWorker" in navigator) window.addEventListener("load", () => navigator.serviceWorker.register("./sw.js?v=20260802-1").catch(console.warn));
